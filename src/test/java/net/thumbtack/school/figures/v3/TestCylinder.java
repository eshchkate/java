...
public class TestCylinder {
    ...
    @Test
    public void testCylinder3C() throws ColorException {
        Point2D center = new Point2D(10, 10);
        int radius = 10;
        int height = 10;
        Cylinder cylinder = new Cylinder(center,radius, height, "RED");
        cylinder.setCenter(new Point2D(5,5));
        cylinder.setRadius(5);
        cylinder.setHeight(5);
        assertEquals(5, cylinder.getCenter().getX());
        assertEquals(5, cylinder.getCenter().getY());
        assertEquals(5, cylinder.getRadius());
        assertEquals(5, cylinder.getHeight());
        assertNotEquals(7, cylinder.getCenter().getX());
        assertNotEquals(7, cylinder.getCenter().getY());
        assertNotEquals(7, cylinder.getRadius());
        assertNotEquals(10, cylinder.getHeight());
    }
