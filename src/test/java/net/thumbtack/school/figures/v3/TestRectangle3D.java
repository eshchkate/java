...
public class TestRectangle3D {
    ...
    @Test
    public void testRectangle3D1C() throws ColorException {
        Point2D topLeft = new Point2D(10, 20);
        Point2D bottomRight = new Point2D(30, 40);
        int height = 10;
        Rectangle3D rect3D = new Rectangle3D(topLeft, bottomRight, height, "RED");
        rect3D.setTopLeft(new Point2D(20,30));
        rect3D.setBottomRight(new Point2D(40,50));
        rect3D.setHeight(20);
        assertEquals(20, rect3D.getTopLeft().getX());
        assertEquals(30, rect3D.getTopLeft().getY());
        assertEquals(40, rect3D.getBottomRight().getX());
        assertEquals(50, rect3D.getBottomRight().getY());
        assertEquals(rect3D.getHeight(), 20);
        assertNotEquals(70, rect3D.getTopLeft().getX());
        assertNotEquals(70, rect3D.getTopLeft().getY());
        assertNotEquals(70, rect3D.getBottomRight().getX());
        assertNotEquals(70, rect3D.getBottomRight().getY());
        assertNotEquals(rect3D.getHeight(), 70);
    }
    ...
    public void testIsPointInsideRectangle3D3() throws ColorException {
        ...
        assertTrue(rect3D.isInside(10, 40,5));
        assertFalse(rect3D.isInside(0, 0,50));
        assertFalse(rect3D.isInside(10, 100,-5));
        assertFalse(rect3D.isInside(-10, 20,50));
        assertFalse(rect3D.isInside(10, -20,10));
    }
    ...
    public void testIsPointInsideRectangle3D4() throws ColorException {
        ...
        assertTrue(rect3D.isInside(new Point3D(10, 30,10)));
        assertTrue(rect3D.isInside(new Point3D(30, 30,5)));
        assertTrue(rect3D.isInside(new Point3D(10, 40,5)));
        assertFalse(rect3D.isInside(new Point3D(0, 0,0)));
        assertFalse(rect3D.isInside(new Point3D(20, 10,55)));
        assertFalse(rect3D.isInside(new Point3D(-10, 20,10)));
        assertFalse(rect3D.isInside(new Point3D(10, -20,-10)));
    }
